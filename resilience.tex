...
and thus a WSTS.
Case A) is $\Safe = \uparrow q_1(3,0)$ and $\Bad = \uparrow q_0(0,0)$, $1$-resilience holds.
Case B) is $\Safe = \uparrow q_0(3,0)$ and $\Bad = \uparrow q_1(0,0)$, resilience do not hold because of $q_1(0,0) \in \Bad$.
...
$\mathds{Z}$-VASS, one counter, $\Safe = \uparrow 0$, $\Bad = \downarrow -1$, transition: $+1$,
then resilience hold but not bounded resilience. 
\end{example}

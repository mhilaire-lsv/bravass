...
\end{remark}
\alain{parfois $\mathscr{S}=(S,\rightarrow,\leq)$ is
(\Bad,\Safe)-resilient parfois $\mathscr{S}=(S,\rightarrow,\leq)$ is 
(\Safe,\Bad)-resilient , rendre cohérent avec $\mathscr{S}=(S,\rightarrow,\leq)$ is
(\Bad,\Safe)-resilient}

...
% The Model-checking problem for LTL, CTL*, etc. is a natural generalization of the reachability problem. This problem is undecidable in general but there are simple formulae decidable 

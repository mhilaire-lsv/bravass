...
$D$ is  defined by ... states where your number of counter is bounded by a constant, and others where it is unbounded. You have $m$ counters where it is bounded by $n$

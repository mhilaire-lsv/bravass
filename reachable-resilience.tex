...
The characterization is used to show that Petri nets are $\post^*$-effective. 

\begin{proposition}
Let $P = (N,M,W)$ be a Petri net and $s \in M$ a configuration of the Petri net, then one can compute a basis of $\uparrow \post^*(s)$.
\end{proposition}

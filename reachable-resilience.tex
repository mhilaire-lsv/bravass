...
Undecidability in general: $\Safe = 0$, $\Bad = S \setminus 0$ ?
...
With strong compatibility hypothesis:

\begin{center}
\begin{tabular}{ | l | c | c | r |}
\hline   \Safe~\Bad & $\uparrow$~ $\downarrow$~ & $\downarrow$~ $\uparrow$~  \\ \hline
   SRP & Undecidable & Undecidable  \\ \hline
   BSRP & Undecidable &  ??  \\ \hline
      kSRP & Undecidable & ?? \\ \hline
 \end{tabular}
\end{center}

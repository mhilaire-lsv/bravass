...
For the sake of clarity, the construction detailled here concerns itself with reset Petri nets rather than reset-VASS. We recall that Petri nets and VASS are equivalents models~%\cite{qui?}
[??].

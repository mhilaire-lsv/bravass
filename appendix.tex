...
The new reset-VASS is constructed by adding two new places
and
$|V_1|+2$ new transitions.

We first modify all transitions to include $r_1$ both as an input and an output

\mathieu{Ok non pas comme ça}

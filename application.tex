...
Je crois que ça résoud aussi un pb résolu dans Valk et Jantzen 1985 mais en utilisant le graphe de karp et Miller donc avec complexité ackerman...à bien vérifier que $\pred^*(\Safe)$ n'est pas ackerman...en lisant en détail \cite{DBLP:conf/rp/BozzelliG11}. Dans ce cas, ça permettrait de résoudre autrement les 4 pbs dans \cite{DBLP:conf/rp/BozzelliG11} avec une complexité 2-exp plutôt qu'ackerman 

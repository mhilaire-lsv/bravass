...
\subsection{Regular Channel Systems}
...
Another proof is possible for LCS which have a (non-computable) regular reachability set. LCS are WSTS with a computable $\uparrow post^*(S)$.

corollary: Lossy Channel Systems.

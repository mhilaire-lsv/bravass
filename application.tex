...
\end{proof}
%
Let us remark that $\uparrow post^*(q,w)$ is also a computable regular language, but we cannot directly apply Theorem \ref{} since PA are not WSTS for the usual orderings (subword, prefix).

...
\cite{DBLP:journals/acta/ValkJ85} showed from a VASS $V$ how to construct another VASS $V'$ that has the property...
...
\begin{theorem}
{\sc Resilience} is decidable for VASS when $\Safe$ is semilinear
and $\Bad = S \setminus \Safe$.
\end{theorem}

\begin{proof}
Hypothesis: $\Safe$ is semilinear, $\Bad = S \setminus \Safe$.
Then $\Bad$ is semilinear too.

...
\cite{DBLP:journals/acta/ValkJ85} showed from a VASS $V$ and one of the 4 properties P, how to construct the maximal VASS $V'$ that has the property P.
...
\alain{c'est la preuve de quoi en dessous ?}
\begin{proof}

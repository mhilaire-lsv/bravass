...
\begin{theorem}{}
{\sc Resilience} is decidable for VASS when $\Safe$ and $\Bad$ are semilinear sets.
\end{theorem}
...
\begin{theorem}{}
{\sc Resilience} is decidable for lossy counter machines when $\Safe$ and $\Bad$ are semilinear.
\end{theorem}
...
=======
The reachability relation of integer $d$-VASS is definable by a sentence in Presburger in $\mathbb{Z}^d$ hence	$\Bad \subseteq \pred^*(\Safe)$ is decidable when $\Safe$ and $\Bad$ are semilinear sets. \qed
>>>>>>> 1bbb43b49bc37d03ff7942356654c25ce6b7db48
...
{\sc Resilience} is decidable for continuous VASS when $\Safe$ and $\Bad$ are definable in the existential theory of
...
=======
the rationals with addition and order whose complexity is EXPSPACE \cite{DBLP:journals/tocl/BlondinFHH17}. Hence, $\Bad \subseteq \pred^*(\Safe)$ is also in EXPSPACE. \qed
>>>>>>> 1bbb43b49bc37d03ff7942356654c25ce6b7db48

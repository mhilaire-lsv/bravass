...
\subsection{VASS, 2-VASS, Lossy Channel Systems, Integer et Continuous VASS}

\subsection{LCM}

\begin{theorem}{se déduit du papier Schnoebelen RP 2010, page 8}
Resilience is decidable for LCM when $\Safe$ and $\Bad$ are semilinear sets.
\end{theorem}

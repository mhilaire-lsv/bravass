...
\mathieu{Pas convaincu qu'un tel $k_0$ existe systématiquement: par exemple $q \times a$ et 
$q \times a b^*$ sont tout les deux réguliers et il n'y a pas de borne maximum sur la taille d'un chemin de $q \times a b^*$ vers $q \times a$.}
% This also solves the BRP as $A=(Q,\Sigma,...)$ is $k_0$-resilient.

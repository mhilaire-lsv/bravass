...
\begin{document}
%
\author{Alain Finkel%\inst{1,2} \and 
Mathieu Hilaire%\inst{1}
}
...
\thanks{This work was partly done while the authors were supported by the Agence Nationale de la Recherche grant BraVAS (ANR-17-CE40-0028).}	%optional
...
\author[A.~Finkel]{Alain Finkel}[a,b]
\author[M.~Hilaire]{Mathieu Hilaire}[a]
...
\begin{defi}[Definition 3.10, \cite{DBLP:journals/iandc/Finkel90}]
...
\begin{defi}(Finkel and Goubault-Larrecq \cite{DBLP:journals/corr/abs-1208-4549})
...
\begin{lem}\label{downward compatible}
...
%
\begin{thm}[Theorem 3.6, \cite{DBLP:journals/tcs/FinkelS01}, Theorem 4.1, \cite{DBLP:journals/iandc/AbdullaCJT00}]
...
%		(Blondin and al., 
%
\begin{thm}[Corollaire 4.4, ~\cite{DBLP:journals/lmcs/BlondinFM17}]
...
%
\begin{thm}[Proposition 5.4, \cite{DBLP:journals/tcs/FinkelS01}]
...
\begin{prop}\label{indec WSTS with dcs}
...
.
\begin{prop}\label{liveness reset}
...
%
%
\begin{thm}[Theorem 1,~\cite{DBLP:conf/gg/Ozkan22}, Theorem 1, ~\cite{DBLP:journals/corr/abs-2108-00889}]\label{ref ozkan}
...
\begin{lem}\label{Lemma intersection}
...
\begin{prop}[Proposition 1, \cite{DBLP:conf/gg/Ozkan22}]\label{post*}
...
\begin{lem}(Symmetrical from Lemma~\ref{Lemma intersection})\label{Lemma intersection 2}
Let $A \subseteq S$, $D \subseteq S$ be a downward-closed set and $U \subseteq S$ be an upward-closed set. 
...
Note that $\post$-effective, $\post$-ideal-effective WSTS, strong downward compatibility and upward compatibility include for instance
Lossy Channel Systems with insertions~\cite{DBLP:journals/iandc/AbdullaJ96}. 

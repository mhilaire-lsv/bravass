...
of elements of $X$) and $(X,\leq)$ contains no infinite antichains (an antichain is a subset of mutually incomparable elements). See other equivalences in \cite{schmitz:cel-00727025}. 
%
%

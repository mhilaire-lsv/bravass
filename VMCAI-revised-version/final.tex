...
Since Resilience is undecidable for  $\omega^2$-WSTS with strong compatibility (Theorem \ref{indec WSTS}), we still consider $\omega^2$-WSTS with strong compatibility but by strengthening the assumptions of effectiveness (we now consider the completion-post-effective hypothesis) we demonstrate that the three resilience problems are decidable.
...
In the case
of a ideal-effective WSTS, {\sc Resilience} is undecidable.

...
We introduce five types of effectivity that will be necessary to decide some resilence problems for differents models of WSTS.\\
\noindent
{\bf On effectivity.}
...
\item {\em completion-post-effective} if
$\mathscr{S}$ is post-effective, and there exists an algorithm $M_\downarrow$ that computes 
...
Since reset-VASS can simulate executions of a Minsky machine, {\sc Resilience} is undecidable for reset-VASS and hence for WSTS in general as well.\alain{déjà dit avant en mieux omega2 et strong comp et post-effective}\qed
\end{proof}

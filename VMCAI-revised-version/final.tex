...
We now prove that {\sc Resilience} is undecidable for reset-VASS when $\Safe = \mathop{\downarrow} \Safe$. 
...
Section~\ref{safe-down} and devellopped more in Appendix~\ref{minsk}.

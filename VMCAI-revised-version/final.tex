...
comes more from the fact $\post^*(s_0)$ is not constructible~\cite{dufourd1998reset} in reset-VASS rather than from the difficulties inherent in searching for paths from $\post^*(s_0)$ to $\Safe$.  \nocite{mayr1998lossy}

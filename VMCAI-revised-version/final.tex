...
Since termination is w.l.o.g. reachability of $q_f({\bf 0})$ \mathieu{est-ce qu'on a pas besoin d'une hypothèse d'être deterministic ici pour que ce soit vraiment w.l.o.g. ??} for some control state $q_f$, we can formulate the structural termination problem as

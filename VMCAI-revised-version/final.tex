...
We now prove that {\sc Resilience} is undecidable for reset-VASS when $\Safe = \mathop{\downarrow} \Safe$. We will use the undecidability of the structural existential halting problem.
%

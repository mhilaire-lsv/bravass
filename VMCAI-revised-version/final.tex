...
Given $(X,\leq)$ a quasi-ordering, an {\em upward-closed set} is any set $U \subseteq X$ such that if $x \leq y$ and $x \in U$ then $y \in U $.
...
its {\em upward-closure},
 $\uparrow A = \{x \in X \mid \exists a \in A ~ a \leq y\}$
 and its 
 {\em downward-closure},

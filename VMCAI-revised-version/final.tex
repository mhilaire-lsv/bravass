...
We recall and introduce five types of \emph{effectiveness} that will be essential for solving various resilience problems in different models of WSTS.
\noindent
%			{\bf On effectivity.}
...
% $s_1, s_2, \ldots, s_m \in S$.
%
\item {\em effective $\post^*$-basis} \cite{DBLP:conf/gg/Ozkan22,DBLP:journals/corr/abs-2108-00889} if there exists an algorithm accepting

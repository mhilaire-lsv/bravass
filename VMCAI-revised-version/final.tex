...
Section~\ref{safe-down} and developped more in Appendix~\ref{minsk}.
...
First, note that deciding whether from all inputs, all runs are terminating
 is undecidable for Minsky machines with at least $2$ counters, and, in particular, for deterministic ones as well~\cite{Min61}. Hence 

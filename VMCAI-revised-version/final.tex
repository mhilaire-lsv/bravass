...
since a run terminates w.l.o.g. if it reaches a terminal state of the form $q_f({\bf 0})$. \qed \end{proof}
...
is stationnary. 
%\mathieu{
We check the finiteness of the set by comparing the finite basis of $\Bad$ and

...
\begin{theorem}(Blondin~\cite{DBLP:journals/lmcs/BlondinFM17})
Coverability is decidable for any ideally-effective WBTS.
\end{theorem}

Downward-WSTS enjoy a powerfull property.

\begin{theorem}\cite{DBLP:journals/tcs/FinkelS01}
...
(\"Ozkan~\cite{DBLP:conf/gg/Ozkan22,DBLP:journals/corr/abs-2108-00889})

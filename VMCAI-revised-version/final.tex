...
We now prove that {\sc Resilience} is undecidable for reset-VASS, hence it will be also undecidable for (upward) compatible WSTS when $\Safe = \mathop{\downarrow} \Safe$.
%
...
{\sc Structural existential halting} is undecidable since termination is undecidable for deterministic counter machines.

...
\caption{ Hasse diagram of some classes of transition systems, together with the decidability (in green) or undecidability (in red) of the resilience problems. Decidability of bounded resilience and $k-$resilience variants are indicated in blue. Detailed notions of effectivity can be found on page~\pageref{on effectivity}. The different models are furthermore introduced in Section~2 and Section~3.}
	\end{figure}
\end{center}

...
\begin{proof}
First, let us show that {\sc Resilience} is undecidable for Minsky machine with at least $2$ counters.
	This is due to the undecidability of $2$-counter Minsky machine termination.
...
from any input is equivalent to the asking whether there exists a terminating run from every input of machine $M$, that is undecidable~\cite{Min61}. 

...
{\sc State-resilience} is decidable for $\post$-effective, $\post$-ideal-effective and effective $\pred$-basis WSTS with downward and upward compatibilities
...
The procedure then check for every downward closed subset $D_i$ whether $\downarrow \post^*(D_i) \subseteq D_i$. 

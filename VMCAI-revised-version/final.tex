...
~	& ? & Undecidable    \\ \hline
   ...
   \multirow{2}{*}{{\bf sRP ~ ~ }} 
   		 & WSTS (downward + upward) Thm~9 & Decidable\\ \cline{2-3}
~	& ~ Reset-VASS, WSTS ($\pred$-basis-effective) Prop~\ref{srp up down}  & Undecidable  \\ \hline
   \multirow{2}{*}{{\bf BsRP }} 
   		 & WSTS (downward + upward) Cor~\ref{downward brp} & Decidable \\ \cline{2-3}
~	&  ? & Undecidable   \\ \hline
   \multirow{2}{*}{{\bf ksRP }} 
   		 & WSTS (downward + upward) Cor~\ref{downward brp} & Decidable\\ \cline{2-3}
~	 & ? & Undecidable    \\ \hline
...
since 
 ...
 is equivalent to
 structural termination in the case of deterministic Minsky machines and thus,
 is undecidable for Minsky machines in general.

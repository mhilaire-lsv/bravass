...
to the encoding of the ideal $\downarrow s$ is computable and inclusion of ideals is decidable.
%
...
%
\end{itemize}
%Most of usual WSTS enjoy most of all effectivities.
...
With the ideally-effective hypothesis, we obtain the decidability of coverability for WBTS.
...
Coverability is  decidable for completion-post-effective and ideally-effective WSTS.
\end{theorem}
...
Resilience for post-effective and ideally effective $\omega^2$-WSTS with strong compatibility, for upward closed sets $\Safe$ is undecidable.
\end{theorem}
...
\end{proof}
 Let us remark that the transition system 
	$S_j = (\N^2, \{f_j, g\}, \leq)$ in the previous proof is not completion-post-effective.
...
Let $\mathscr{S}=(S,\rightarrow, \leq)$ be a completion-post-effective and ideally-effective WSTS with strong compatibility and a set $\Safe = \uparrow \Safe$.
...
Since coverability is decidable for completion-post-effective and ideally-effective WSTS \cite{BFM-ic17}, we deduce that both the 
...
\begin{proof}
\alain{est-ce sur qu'on peut rajouter l'hypothese "ideal-effective" ? oui. et completion-post-effective ?...... preuve pas claire, à réécrire}
...
{\sc State-resilience} is decidable for ideally-effective and completion-post-effective WSTS with downward and upward compatibilities,
$\Safe = \downarrow \Safe$.
\end{theorem}
...
{\sc $k$-state-resilience} and {\sc bounded-state-resilience} are decidable for ideally-effective and completion-post-effective WSTS with strong downward compatibility and upward compatibility when
$\Safe = \downarrow \Safe$.
\end{corollary}
...
completion-post-effective and ideally-effective WSTS with strong compatibility (in the case 

...
The computability of $\uparrow \post^*(s)$ however seems a strong hypothesis. What are the WSTS for which $\uparrow \post^*(s)$ is computable for $s \in S$ ? \alain{One first answer is the class of effective downward-WSTS which are precisely effective $\post^*$-basis}. Moreover, 

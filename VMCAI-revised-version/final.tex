...
{\sc Resilience} for ideal-effective $\omega^2$-WSTS with strong compatibility and for downward closed set $\Safe$ is undecidable.
\end{theorem}
\alain{est-ce sur qu'on peut rajouter l'hypothese "ideal-effective" ? oui. et completion-post-effective ?}

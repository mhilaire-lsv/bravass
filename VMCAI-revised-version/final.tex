...
comes more from the fact $\post^*(s_0)$ is not constructible~\cite{mayr1998lossy} in reset-VASS rather than from the difficulties inherent in searching for paths from $\post^*(s_0)$ to $\Safe$.  

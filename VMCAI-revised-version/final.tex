...
%
%
Wqo admits many other equivalent formulations like : a qo $(X,\leq)$ is a wqo iff every upward-closed set $\emptyset \neq U \subseteq X$ admits a finite basis $B \subseteq X$ such that $U=\uparrow B$ iff $(X,\leq)$ is well founded (i.e. there is no infinite strictly decreasing sequence

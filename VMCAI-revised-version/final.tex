...
%
\alain{je pense qu'il y a une erreur, on n'utilise pas le Lemme 2}
%
...
%
%
\alain{je pense qu'il y a une erreur, je propose plutôt}
%
...
%
Since both $B_{\mathop{\uparrow} \post^*(s)}$ and $B_{\pred^*(\Safe)}$ are finite, {\sc State-resilience} is decidable.
%
\alain{ce qui suit est à enlever je l'ai commenté (à vérifier)}
%

...
\phantom{Fridge.png} \\
\phantom{Fridge.png} \\
$\Bad$ states = temperature $> 6^\circ C$ \newline

 $\Safe$ states = temperature $\leq 6^\circ C$ \\
...
\end{columns}
 ...
 \vspace{0.25cm}
  ...
  \only<2>{
$q_0(n) \to q_1(n-1) \to^* q_1(0) $ \phantom{$q_0(9) q_0(10)$} $ q_1(k+1) \cancel{\to^{\leq k}} q_1(0)$
}
...
\end{columns}
 ...
 \only<2>{
$q_1(9) \to q_0(10) \to q_2(0) \to q_1(0)$
}
...
% \nocite{DBLP:conf/gg/Ozkan22}
 \nocite{DBLP:journals/corr/abs-2108-00889}
...
\end{columns}
 ...
 \hspace{-0.6cm} $q_2(10,10) \to q_1(13,14) \to^* q_1(2,3) $ \phantom{VA} $ q_1(k+4,k+4) \cancel{\to^{\leq k}} q_1(3,3)$
...
$\Bad$ and $\Safe$ are both semilinear~\cite{janvcar2023semilinear}

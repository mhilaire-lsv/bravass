...
%  \todo[inline,color=blue!20]{    \tiny Definition right now is very formal for a slideshow, maybe make it less verbose? }
  ...
  \end{frame}
%vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  \begin{frame}{WSTS with strong compatibility}
...
\begin{definition}
A  Well-Structured Transition System {\em with \textcolor{red}{strong} compatibility}  $\mathscr{S}=(S, \rightarrow, \leq)$
is a transition system $(S, \rightarrow)$
equipped with a wqo ${\leq} \subseteq S \times S$ such that   
the transition relation $ \rightarrow$ is \textcolor{red}{strongly} (upward) compatible with $\leq$, i.e., for all 
$s_1, t_1 , s_2 \in S$
	with $s_1 \leq s_2$  and $s_1 \rightarrow t_1$, there exists 
	$t_2 \in S$ with 
	$t_1 \leq t_2$ and $s_2 \textcolor{red}{\rightarrow} t_2$.
\end{definition}
...
%
\item {\em $\pred$-basis-effective}  = 

effective +  $s \in S \to$ a finite basis of $\mathop{\uparrow} \pred(\mathop{\uparrow} s)$ computable

\cite{DBLP:journals/tcs/FinkelS01,DBLP:journals/iandc/AbdullaCJT00}
%
...
%
\item {\em $\post^*$-basis-effective} = 

effective +  $s \in S \to$ a finite basis of $\mathop{\uparrow} \post^*(s)$ computable
%

\cite{DBLP:conf/gg/Ozkan22,DBLP:journals/corr/abs-2108-00889} 
\item {\em $\pred^*$-basis-effective} = 

effective +  $I \in Ideals(S) \to$ a finite basis of $\mathop{\downarrow} \pred^*(I)$ computable
\end{enumerate}
...
\begin{itemize}
\item $\post$-ideal-effective 
\item strong compatibility
...
% 	$\to$ ideal decomposition of Bad
	
%	$\to$ basis of Safe
	
 	$\to$ resilience =$>$ infinite number of coverability questions

	$\to$ introduce the completion
	
	$\to$  here resilience =$>$ finite number of coverability questions


  \end{frame}
%vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  \begin{frame}{Ingredient 1: the completion}
...
\end{exampleblock}
   ...
   \end{frame}
%vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  \begin{frame}{Ingredient 2: link with coverability}
...
This infinite set of coverability questions can be reduced to a \emph{finite} set of coverability questions in the completion $\hat{\mathscr{S}}=(Ideals(S),\rightarrow, \subseteq)$ of $\mathscr{S}=(S,\rightarrow, \leq)$. 
 \end{block}
    ...
    \end{frame}
%vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  \begin{frame}{Ingredient 3}
  
    \begin{block}{ }
This infinite set of coverability questions can be reduced to a \emph{finite} set of coverability questions in the completion $\hat{\mathscr{S}}=(Ideals(S),\rightarrow, \subseteq)$ of $\mathscr{S}=(S,\rightarrow, \leq)$. 
 \end{block}
 
 $\to$ consider max length of such coverability questions
 
  $\to$ answers {\sc Bounded resilience} and {\sc $k$-resilience} as well
     \todo[inline,color=blue!20]{ 
  ... actually it is generally over now maybe we don't have to go into all the details here
}
...
\end{center}  
  ...
  \end{frame}
%vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  \begin{frame}{State Resilience when $\Safe = {\uparrow \Safe}$}
...
\end{center}  
  ...
  \end{frame}
%vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  \begin{frame}{Resilience for VASS}
...
- Remarque additionnelle du coup

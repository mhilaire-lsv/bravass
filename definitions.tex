...
\end{proof}
\textcolor{blue}{Alain: non ceci est vrai seulement si le quasi ordre est un ordre cad antisymétrique. Mais ce n'est pas un pb. Relis mon papier de 2016 sur les well abstracted...}
...
% Lemma 3 ([1]) 
% Parosh Aziz Abdulla, Karlis Cerans, Bengt Jonsson & Yih-Kuen Tsay (1996): General Decidability Theorems for Infinite-State Systems. In: Proc. LICS 1996, IEEE Computer Society Press, pp. 313–321,
 Given a basis of an upward-closed set $I \subseteq S$, and a state $s$ of a strongly well-structured transition

...
\alain{examiner les cas I,J un élement, cloture, tout, ...}
...
\begin{proposition}
{\sc $k$-resilience}, hence {\sc resilience}, is undecidable for effective WSTS with strong upward compatibility.
\end{proposition}

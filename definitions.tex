...
\begin{proof}
on choisit $J=S$ ou $Reach(S)$. {$\forall s  \exists s'' \in I ~ s' \rightarrow^{\leq k} s''$ ?\newline}. il existe un chemin infini passant par inft par $q$, liveness undecidable LCS, Reset, WSTS.
\end{proof}

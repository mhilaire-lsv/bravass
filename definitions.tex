...
{\bf On effectivity}
A WSTS $\mathscr{S}=(S, \rightarrow, \leq)$ is {\em effective} if there exists a pair of algorithms
...
A WSTS $\mathscr{S}=(S, \rightarrow, \leq)$ has {\em effective pred-basis} \cite{DBLP:journals/tcs/FinkelS01,DBLP:journals/iandc/AbdullaCJT00} if there exists an algorithm accepting
...
%We say that $\mathscr{S}$ is {\em upward pre-effective} if it is effective,

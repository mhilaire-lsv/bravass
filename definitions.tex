...
%
plus simple : la $(D,U)$-resilience: $D \rightarrow^{\leq k} U$ ?  \alain{ça signifie pour tout $d \in D$ il existe un chemin de longueur $\leq k$ qui arrive dans un $u \in U$. c'est plus simple et plus général et ça ne demande moins de décider l'accessibilité....comment faire pour vérifier pour tous les (D,U) ? sinon ça dépend tjs de l'état intial $s$ et s'il faut vérifier pour tous les $s$....}

...
\begin{definition}
A {\em vector addition system with states (VASS)} in dimension $d$ ($d$-VASS for short) is a finite $\mathds{Z}^d$-labeled directed graph $V = (Q,T)$, where $Q$ will be referred to as the {\em control states} of $V$, and where $T \subseteq Q \times \mathds{Z}^d \times Q$ will be referred to as the {\em control transitions} of $V$. 
